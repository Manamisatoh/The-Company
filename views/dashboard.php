<?php
    ...
    $user = new User;
    $all_users = $user->getAllUsers(); // holds all user's data
                ...
                <tbody>
                    <?php
                        while($user = $all_users->fetch_assoc()) {
                            //$user = [id =>1, first_name => Manami,  ....
                    ?> 
                    <!-- photo, id, names, buttons -->
                    <tr>
                        <td>
                            <?php // if the user has the photo or not
                                if($user['photo']){
                            ?>
                        ...
                        <td>
                            <?php // if the user has logged in already, display the functional buttons
                                if($user['id'] == $_SESSION['id']){ // id is very unique
                            ?>
